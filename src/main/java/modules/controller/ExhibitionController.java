...
public class ExhibitionController {
    ...
    @ApiOperation(value = "查询单个作品小程序所有传exhibition的id", notes = "查询单个小程序所有 关联一级评论表main_comment和二级评论表minor_comment")
    @PostMapping(value = "/selectById")
    @ResponseBody
    public Result selectById(@RequestBody ExhibitionIdDto exhibitionIdDto) {
        ExhibitionReturnVo list=iExhibitionService.selectById(exhibitionIdDto);
    ...
    public Result thumbsById(@RequestBody UserIdDto userIdDto) {
        NumberTypeVo numberTypeVo=iExhibitionService.thumbsById(userIdDto);
    ...
    public Result followsById(@RequestBody UserIdDto userIdDto) {
        NumberTypeVo numberTypeVo=iExhibitionService.followsById(userIdDto);
        return Result.OK(numberTypeVo);
    }
